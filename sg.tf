...
resource "aws_security_group_rule" "allow_8200_vault" {
  type              = "ingress"
  from_port         = 8200
  to_port           = 8205
  protocol          = "tcp"
...
resource "aws_security_group_rule" "allow_443_controller" {
  type              = "ingress"
  from_port         = 443
  to_port           = 443
  protocol          = "tcp"
...
resource "aws_security_group_rule" "allow_5432_controller" {
  type              = "ingress"
  from_port         = 5432
  to_port           = 5432
  protocol          = "tcp"
